...
Linux: [![Circle CI](https://circleci.com/gh/conda-forge/r-smoothmest-feedstock.svg?style=shield)](https://circleci.com/gh/conda-forge/r-smoothmest-feedstock)
OSX: [![TravisCI](https://travis-ci.org/conda-forge/r-smoothmest-feedstock.svg?branch=master)](https://travis-ci.org/conda-forge/r-smoothmest-feedstock)
Windows: [![AppVeyor](https://ci.appveyor.com/api/projects/status/github/conda-forge/r-smoothmest-feedstock?svg=True)](https://ci.appveyor.com/project/conda-forge/r-smoothmest-feedstock/branch/master)

Current release info
====================
Version: [![Anaconda-Server Badge](https://anaconda.org/conda-forge/r-smoothmest/badges/version.svg)](https://anaconda.org/conda-forge/r-smoothmest)
Downloads: [![Anaconda-Server Badge](https://anaconda.org/conda-forge/r-smoothmest/badges/downloads.svg)](https://anaconda.org/conda-forge/r-smoothmest)
